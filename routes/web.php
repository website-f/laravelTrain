...
Route::get('/class/{id}', [ClassController::class, 'details'])->middleware('auth');
Route::get('/class/student/{id}', [StudentController::class, 'details'])->middleware('auth');
...
Route::get('/extracurricular/{id}', [ExtracurricularController::class, 'details'])->middleware('auth');

Route::get('/teacher', [TeacherController::class, 'index'])->middleware('auth');
Route::get('/teacher/{id}', [TeacherController::class, 'details'])->middleware('auth');
